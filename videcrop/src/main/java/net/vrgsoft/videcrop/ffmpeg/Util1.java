...
class Util1 {
    ...
    static String convertInputStreamToString(InputStream inputStream) {
        try {
            ...
            Log1.e("error converting input stream to string", e);
        }
        return null;
    }
    ...
    static void destroyProcess(Process process) {
        if (process != null) {
            try {
                ...
                Log1.e("progress destroy error", e);
            }
        }
    }
    ...
    static FFbinaryObserver1 observeOnce(final ObservePredicate predicate, final Runnable run, final int timeout) {
        final android.os.Handler observer = new android.os.Handler();


        final FFbinaryObserver1 observeAction = new FFbinaryObserver1() {
