...
public class CropVideoView1 extends FrameLayout {
    ...
    public CropVideoView1(Context context) {
        super(context);
        init(context);
    }

    public CropVideoView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CropVideoView1, 0, 0);

        try {
            mGuidelines = ta.getInteger(R.styleable.CropVideoView1_guidelines, 1);
            mFixAspectRatio = ta.getBoolean(R.styleable.CropVideoView1_fixAspectRatio, false);
            mAspectRatioX = ta.getInteger(R.styleable.CropVideoView1_aspectRatioX, 1);
            mAspectRatioY = ta.getInteger(R.styleable.CropVideoView1_aspectRatioY, 1);
        } finally {
            ta.recycle();
        }
