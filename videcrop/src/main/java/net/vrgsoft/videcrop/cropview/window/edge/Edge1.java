...
public enum Edge1 {
    ...
    public void adjustCoordinate(float aspectRatio) {
        ...
        switch(this) {
            case LEFT:
                this.mCoordinate = AspectRatioUtil1.calculateLeft(top, right, bottom, aspectRatio);
                break;
            case TOP:
                this.mCoordinate = AspectRatioUtil1.calculateTop(left, right, bottom, aspectRatio);
                break;
            case RIGHT:
                this.mCoordinate = AspectRatioUtil1.calculateRight(left, top, bottom, aspectRatio);
                break;
            case BOTTOM:
                this.mCoordinate = AspectRatioUtil1.calculateBottom(left, top, right, aspectRatio);
        }

    }

    public boolean isNewRectangleOutOfBounds(Edge1 edge, Rect imageRect, float aspectRatio) {
        ...
        switch(this) {
            case LEFT:
                if (edge.equals(TOP)) {
                    ...
                    bottom = AspectRatioUtil1.calculateLeft(right, top, left, aspectRatio);
                ...
                if (edge.equals(BOTTOM)) {
                    ...
                    top = RIGHT.getCoordinate();
                    bottom = AspectRatioUtil1.calculateLeft(left, top, right, aspectRatio);
            ...
            case TOP:
                if (edge.equals(LEFT)) {
                    ...
                    bottom = AspectRatioUtil1.calculateTop(right, left, top, aspectRatio);
                ...
                if (edge.equals(RIGHT)) {
                    ...
                    top = BOTTOM.getCoordinate();
                    bottom = AspectRatioUtil1.calculateTop(left, right, top, aspectRatio);
            ...
            case RIGHT:
                if (edge.equals(TOP)) {
                    ...
                    bottom = AspectRatioUtil1.calculateRight(top, right, left, aspectRatio);
                ...
                if (edge.equals(BOTTOM)) {
                    ...
                    left = TOP.getCoordinate() - offset;
                    top = LEFT.getCoordinate();
                    bottom = AspectRatioUtil1.calculateRight(top, left, right, aspectRatio);
            ...
            case BOTTOM:
                if (edge.equals(LEFT)) {
                    ...
                    bottom = AspectRatioUtil1.calculateBottom(right, top, left, aspectRatio);
                ...
                if (edge.equals(RIGHT)) {
                    ...
                    left = LEFT.getCoordinate() - offset;
                    top = TOP.getCoordinate();
                    bottom = AspectRatioUtil1.calculateBottom(left, top, right, aspectRatio);
