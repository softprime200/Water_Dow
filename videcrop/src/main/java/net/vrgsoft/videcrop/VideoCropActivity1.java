...
import net.vrgsoft.videcrop.cropview.window.CropVideoView1;
import net.vrgsoft.videcrop.ffmpeg.ExecuteBinaryResponseHandler1;
import net.vrgsoft.videcrop.ffmpeg.FFmpeg1;
import net.vrgsoft.videcrop.ffmpeg.FFtask1;
import net.vrgsoft.videcrop.player.VideoPlayer1;
import net.vrgsoft.videcrop.view.ProgressView1;
import net.vrgsoft.videcrop.view.VideoSliceSeekBarH1;
...
public class VideoCropActivity1 extends AppCompatActivity implements VideoPlayer1.OnProgressUpdateListener, VideoSliceSeekBarH1.SeekBarChangeListener {
    ...
    private VideoPlayer1 mVideoPlayer;
    ...
    private VideoSliceSeekBarH1 mTmbProgress;
    private CropVideoView1 mCropVideoView;
    ...
    private ProgressView1 mProgressBar;

    private String inputPath;
    private String outputPath;
    private boolean isVideoPlaying = false;
    private boolean isAspectMenuShown = false;
    private FFtask1 mFFTask;
    private FFmpeg1 mFFMpeg;
...
//        mTvAspect16by9 = findViewById(R.id.tvAspect16by9);
        ...
        square_bg=findViewById(R.id.squar);
...
//
//                        Toast.makeText(VideoCropActivity1.this,"same Size",Toast.LENGTH_SHORT).show();
//                    }
...
//        mIvPlay.setImageResource(R.drawable.ic_pause);
    ...
    private void initPlayer(String uri) {
        ...
        mVideoPlayer = new VideoPlayer1(this);
...
//        Toast.makeText(VideoCropActivity1.this,"same Size= " + AspectRatio ,Toast.LENGTH_SHORT).show();
//
//        if (AspectRatio>1.75 && AspectRatio <1.79){
//
//            Toast.makeText(VideoCropActivity1.this,"same Size",Toast.LENGTH_SHORT).show();
...
//            };
//
////            mFFTask = mFFMpeg.execute(cmd, new ExecuteBinaryResponseHandler1() {
////                @Override
...
////                    Toast.makeText(VideoCropActivity1.this, "Failed to crop!", Toast.LENGTH_SHORT).show();
////
//////
////
////                }
...
//    }
    ...
    private void handleConvertStart() {
        ...
        mFFMpeg = FFmpeg1.getInstance(this);
        if (mFFMpeg.isSupported()) {
            String[] cmd = {
...
//                    mIvPlay.setEnabled(true);
                    ...
                    mTvCropProgress.setVisibility(View.INVISIBLE);
                    mTvCropProgress.setText("0%");
                    Toast.makeText(VideoCropActivity1.this, "Finished converting", Toast.LENGTH_SHORT).show();
...
//            };
            ...
            String[] cmd = {"-y" ,"-i",
                    inputPath,"-strict","experimental",
                    "-vf", "movie=/storage/emulated/0/Pictures/Screenshots/c.png [watermark]; [in][watermark] overlay=(main_w-overlay_w-10)/2:(main_h-overlay_h-10)/2 [out]",
                    "-s", "576x1024","-r", "30", "-b", "15496k", "-vcodec", "mpeg4","-ab", "48000", "-ac", "2", "-ar", "22050",
                    outputPath};
            ...
            mFFTask = mFFMpeg.execute(cmd, new ExecuteBinaryResponseHandler1() {
                ...
                @Override
                public void onFailure(String message) {
                    Toast.makeText(VideoCropActivity1.this, "Failed to download!", Toast.LENGTH_SHORT).show();
...
//                    mIvPlay.setEnabled(true);
                    ...
                    mTvCropProgress.setText("0%");
//                    Toast.makeText(VideoCropActivity1.this, "Finished crop", Toast.LENGTH_SHORT).show();
                }
